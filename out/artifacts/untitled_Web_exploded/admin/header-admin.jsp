...
<head>
    ...
    <title>IndUk Admin - Dashboard</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../admin">
            ...
            <div class="sidebar-brand-text mx-3">IndUk Admin</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="roomList.do">
        ...
        <li class="nav-item">
            <a class="nav-link" href="restaurantsList.do">
                <i class="fas fa-bed"></i>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control bg-light border-0 small" placeholder="Header Test"
